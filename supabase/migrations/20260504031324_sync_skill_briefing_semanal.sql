-- Sync ai_agent_config.system_prompt with SKILL_CORE (Etapa 2 — Briefing semanal)
INSERT INTO public.ai_agent_config_history (config_id, system_prompt, model, temperature, max_tokens, changed_by, change_note)
SELECT id, system_prompt, model, temperature, max_tokens, NULL, 'Pre-sync snapshot before Etapa 2 (Briefing semanal)'
