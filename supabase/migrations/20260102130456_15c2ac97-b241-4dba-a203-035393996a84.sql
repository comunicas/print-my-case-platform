...
ADD COLUMN catalog_modal_text TEXT DEFAULT '🎁 Presente para você: R$ 10 OFF na sua próxima compra!';

-- Drop existing function and recreate with new column
