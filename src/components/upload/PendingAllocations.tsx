...
import { AlertTriangle, Check, X, CheckCheck, Loader2 } from "lucide-react";
import { formatDistanceToNow } from "date-fns";
import { ptBR } from "date-fns/locale";

export function PendingAllocations() {
  const { pendingAllocations, count, acceptAllocation, rejectAllocation, acceptAll } = usePendingAllocations();
